...
Gem::Specification.new do |spec|
  ...
  spec.summary       = %q{Crowdin2csv converts xliff file from crowdin.com into CSV file.}
  spec.description   = %q{Crowdin2csv converts xliff file from crowdin.com into CSV file.}
